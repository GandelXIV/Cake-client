...
public class BlockTNT extends Block {
   ...
   public void func_180652_a(World p_180652_1_, BlockPos p_180652_2_, Explosion p_180652_3_) {
      if(!p_180652_1_.field_72995_K) {
         EntityTNTPrimed var4 = new EntityTNTPrimed(p_180652_1_, (double)((float)p_180652_2_.func_177958_n() + 0.5F), (double)((float)p_180652_2_.func_177956_o() + 0.5F), (double)((float)p_180652_2_.func_177952_p() + 0.5F), p_180652_3_.func_94613_c());
         var4.field_70516_a = p_180652_1_.field_73012_v.nextInt(var4.field_70516_a / 4) + var4.field_70516_a / 8;
         p_180652_1_.func_72838_d(var4);
      }
   }
   ...
   public void func_180692_a(World p_180692_1_, BlockPos p_180692_2_, IBlockState p_180692_3_, EntityLivingBase p_180692_4_) {
      if(!p_180692_1_.field_72995_K) {
         if(((Boolean)p_180692_3_.func_177229_b(field_176246_a)).booleanValue()) {
            EntityTNTPrimed var5 = new EntityTNTPrimed(p_180692_1_, (double)((float)p_180692_2_.func_177958_n() + 0.5F), (double)((float)p_180692_2_.func_177956_o() + 0.5F), (double)((float)p_180692_2_.func_177952_p() + 0.5F), p_180692_4_);
            p_180692_1_.func_72838_d(var5);
            p_180692_1_.func_72956_a(var5, "game.tnt.primed", 1.0F, 1.0F);
         }
   ...
   public boolean func_180639_a(World p_180639_1_, BlockPos p_180639_2_, IBlockState p_180639_3_, EntityPlayer p_180639_4_, EnumFacing p_180639_5_, float p_180639_6_, float p_180639_7_, float p_180639_8_) {
      if(p_180639_4_.func_71045_bC() != null) {
         Item var9 = p_180639_4_.func_71045_bC().func_77973_b();
   ...
   public void func_180634_a(World p_180634_1_, BlockPos p_180634_2_, IBlockState p_180634_3_, Entity p_180634_4_) {
      if(!p_180634_1_.field_72995_K && p_180634_4_ instanceof EntityArrow) {
         EntityArrow var5 = (EntityArrow)p_180634_4_;
         if(var5.func_70027_ad()) {
            this.func_180692_a(p_180634_1_, p_180634_2_, p_180634_1_.func_180495_p(p_180634_2_).func_177226_a(field_176246_a, Boolean.valueOf(true)), var5.field_70250_c instanceof EntityLivingBase?(EntityLivingBase)var5.field_70250_c:null);
