...
public class PropertyDirection extends PropertyEnum {
   ...
   protected PropertyDirection(String p_i45650_1_, Collection p_i45650_2_) {
   ...
   public static PropertyDirection func_177712_a(String p_177712_0_, Predicate p_177712_1_) {
      return func_177713_a(p_177712_0_, Collections2.filter(Lists.newArrayList(EnumFacing.values()), p_177712_1_));
   }

   public static PropertyDirection func_177713_a(String p_177713_0_, Collection p_177713_1_) {
