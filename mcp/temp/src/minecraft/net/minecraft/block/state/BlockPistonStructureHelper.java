...
public class BlockPistonStructureHelper {
   ...
   private boolean func_177251_a(BlockPos p_177251_1_) {
      Block var2 = this.field_177261_a.func_180495_p(p_177251_1_).func_177230_c();
      if(var2.func_149688_o() == Material.field_151579_a) {
         ...
         if(var3 + this.field_177258_e.size() > 12) {
            ...
            while(var2 == Blocks.field_180399_cE) {
               BlockPos var4 = p_177251_1_.func_177967_a(this.field_177257_d.func_176734_d(), var3);
            ...
            for(var5 = var3 - 1; var5 >= 0; --var5) {
               this.field_177258_e.add(p_177251_1_.func_177967_a(this.field_177257_d.func_176734_d(), var5));
               ++var10;
            }
            ...
            while(true) {
               BlockPos var6 = p_177251_1_.func_177967_a(this.field_177257_d, var5);
   ...
   private boolean func_177250_b(BlockPos p_177250_1_) {
      ...
      for(int var4 = 0; var4 < var3; ++var4) {
         ...
         if(var5.func_176740_k() != this.field_177257_d.func_176740_k() && !this.func_177251_a(p_177250_1_.func_177972_a(var5))) {
            return false;
         }
      }
