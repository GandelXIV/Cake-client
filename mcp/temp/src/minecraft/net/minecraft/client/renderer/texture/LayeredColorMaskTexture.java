...
public class LayeredColorMaskTexture extends AbstractTexture {
   ...
   public void func_110551_a(IResourceManager p_110551_1_) throws IOException {
      ...
      BufferedImage var2;
      try {
         BufferedImage var3 = TextureUtil.func_177053_a(p_110551_1_.func_110536_a(this.field_174948_g).func_110527_b());
         ...
         for(int var6 = 0; var6 < this.field_174949_h.size() && var6 < this.field_174950_i.size(); ++var6) {
            ...
            if(var7 != null) {
               InputStream var9 = p_110551_1_.func_110536_a(new ResourceLocation(var7)).func_110527_b();
