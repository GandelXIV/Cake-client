   ...
   static class Deserializer implements JsonDeserializer {
      ...
      private BlockPartRotation func_178256_a(JsonObject p_178256_1_) {
         ...
         if(p_178256_1_.has("rotation")) {
            JsonObject var3 = JsonUtils.func_152754_s(p_178256_1_, "rotation");
      ...
      private float func_178255_b(JsonObject p_178255_1_) {
         float var2 = JsonUtils.func_151217_k(p_178255_1_, "angle");
      ...
      private EnumFacing.Axis func_178252_c(JsonObject p_178252_1_) {
         String var2 = JsonUtils.func_151200_h(p_178252_1_, "axis");
      ...
      private Map func_178253_b(JsonDeserializationContext p_178253_1_, JsonObject p_178253_2_) {
         ...
         JsonObject var4 = JsonUtils.func_152754_s(p_178253_2_, "faces");
      ...
      private EnumFacing func_178248_a(String p_178248_1_) {
         EnumFacing var2 = EnumFacing.func_176739_a(p_178248_1_);
         if(var2 == null) {
      ...
      private Vector3f func_178251_a(JsonObject p_178251_1_, String p_178251_2_) {
         JsonArray var3 = JsonUtils.func_151214_t(p_178251_1_, p_178251_2_);
         if(var3.size() != 3) {
            ...
            for(int var5 = 0; var5 < var4.length; ++var5) {
               var4[var5] = JsonUtils.func_151220_d(var3.get(var5), p_178251_2_ + "[" + var5 + "]");
            }
