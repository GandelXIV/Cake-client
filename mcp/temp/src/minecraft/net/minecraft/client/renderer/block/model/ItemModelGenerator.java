...
public class ItemModelGenerator {
   ...
   public static final List field_178398_a = Lists.newArrayList(new String[]{"layer0", "layer1", "layer2", "layer3", "layer4"});
   ...
   public ModelBlock func_178392_a(TextureMap p_178392_1_, ModelBlock p_178392_2_) {
      ...
      for(int var5 = 0; var5 < field_178398_a.size(); ++var5) {
         ...
         if(!p_178392_2_.func_178300_b(var6)) {
            break;
         }

         String var7 = p_178392_2_.func_178308_c(var6);
         var3.put(var6, var7);
         TextureAtlasSprite var8 = p_178392_1_.func_110572_b((new ResourceLocation(var7)).toString());
      ...
      if(var4.isEmpty()) {
         ...
         var3.put("particle", p_178392_2_.func_178300_b("particle")?p_178392_2_.func_178308_c("particle"):(String)var3.get("layer0"));
         return new ModelBlock(var4, var3, false, false, new ItemCameraTransforms(p_178392_2_.func_178296_g(), p_178392_2_.func_178306_h(), p_178392_2_.func_178301_i(), p_178392_2_.func_178297_j()));
      }
   }
   ...
   private List func_178397_a(TextureAtlasSprite p_178397_1_, String p_178397_2_, int p_178397_3_) {
      float var4 = (float)p_178397_1_.func_94211_a();
      float var5 = (float)p_178397_1_.func_94216_b();
   ...
   private List func_178393_a(TextureAtlasSprite p_178393_1_) {
      int var2 = p_178393_1_.func_94211_a();
      int var3 = p_178393_1_.func_94216_b();
      ArrayList var4 = Lists.newArrayList();

      for(int var5 = 0; var5 < p_178393_1_.func_110970_k(); ++var5) {
         int[] var6 = p_178393_1_.func_147965_a(var5)[0];
