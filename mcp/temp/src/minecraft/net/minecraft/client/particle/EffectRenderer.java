         ...
         for(int var9 = 0; var9 < 2; ++var9) {
            if(!this.field_78876_b[var8][var9].isEmpty()) {
               ...
               for(int var12 = 0; var12 < this.field_78876_b[var8][var9].size(); ++var12) {
                  ...
                  var11.func_178963_b(var13.func_70070_b(p_78874_2_));
         ...
         for(int var4 = 0; var4 < var3; ++var4) {
            for(int var5 = 0; var5 < var3; ++var5) {
               for(int var6 = 0; var6 < var3; ++var6) {
                  double var7 = (double)p_180533_1_.func_177958_n() + ((double)var4 + 0.5D) / (double)var3;
                  double var9 = (double)p_180533_1_.func_177956_o() + ((double)var5 + 0.5D) / (double)var3;
                  double var11 = (double)p_180533_1_.func_177952_p() + ((double)var6 + 0.5D) / (double)var3;
