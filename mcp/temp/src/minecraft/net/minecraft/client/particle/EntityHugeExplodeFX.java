...
public class EntityHugeExplodeFX extends EntityFX {
   ...
   public void func_70071_h_() {
      for(int var1 = 0; var1 < 6; ++var1) {
         ...
         this.field_70170_p.func_175688_a(EnumParticleTypes.EXPLOSION_LARGE, var2, var4, var6, (double)((float)this.field_70579_a / (float)this.field_70580_aq), 0.0D, 0.0D, new int[0]);
      }
