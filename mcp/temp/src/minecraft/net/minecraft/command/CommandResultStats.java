...
public class CommandResultStats {
   ...
   public void func_179672_a(ICommandSender p_179672_1_, CommandResultStats.Type p_179672_2_, int p_179672_3_) {
      ...
      if(var4 != null) {
         ...
         if(var6 != null) {
            Scoreboard var7 = p_179672_1_.func_130014_f_().func_96441_U();
            ScoreObjective var8 = var7.func_96518_b(var6);
            if(var8 != null) {
               if(var7.func_178819_b(var5, var8)) {
                  Score var9 = var7.func_96529_a(var5, var8);
                  var9.func_96647_c(p_179672_3_);
               }
            }
         }
      }
   ...
   public void func_179668_a(NBTTagCompound p_179668_1_) {
      if(p_179668_1_.func_150297_b("CommandStats", 10)) {
         NBTTagCompound var2 = p_179668_1_.func_74775_l("CommandStats");
   ...
   public void func_179670_b(NBTTagCompound p_179670_1_) {
      ...
      if(!var2.func_82582_d()) {
         p_179670_1_.func_74782_a("CommandStats", var2);
      }
