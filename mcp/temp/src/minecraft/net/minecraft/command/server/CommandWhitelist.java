   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      if(p_71515_2_.length < 1) {
         ...
         if(p_71515_2_[0].equals("on")) {
            ...
            p_71515_1_.func_145747_a(new ChatComponentText(func_71527_a(var4)));
         } else {
            GameProfile var5;
            if(p_71515_2_[0].equals("add")) {
               ...
               var5 = var3.func_152358_ax().func_152655_a(p_71515_2_[1]);
               if(var5 == null) {
               ...
               var5 = var3.func_71203_ab().func_152599_k().func_152706_a(p_71515_2_[1]);
               if(var5 == null) {
