...
public class CraftingManager {
   ...
   private final List field_77597_b = Lists.newArrayList();
   ...
   public ItemStack func_82787_a(InventoryCrafting p_82787_1_, World p_82787_2_) {
      ...
      } while(!var4.func_77569_a(p_82787_1_, p_82787_2_));

      return var4.func_77572_b(p_82787_1_);
   }
   ...
   public ItemStack[] func_180303_b(InventoryCrafting p_180303_1_, World p_180303_2_) {
      ...
      while(var3.hasNext()) {
         ...
         if(var4.func_77569_a(p_180303_1_, p_180303_2_)) {
            return var4.func_179532_b(p_180303_1_);
         }
      }

      ItemStack[] var5 = new ItemStack[p_180303_1_.func_70302_i_()];

      for(int var6 = 0; var6 < var5.length; ++var6) {
         var5[var6] = p_180303_1_.func_70301_a(var6);
      }
