...
public class WorldManager implements IWorldAccess {
   ...
   public void func_180441_b(int p_180441_1_, BlockPos p_180441_2_, int p_180441_3_) {
      Iterator var4 = this.field_72783_a.func_71203_ab().field_72404_b.iterator();

      while(var4.hasNext()) {
         EntityPlayerMP var5 = (EntityPlayerMP)var4.next();
         if(var5 != null && var5.field_70170_p == this.field_72782_b && var5.func_145782_y() != p_180441_1_) {
            double var6 = (double)p_180441_2_.func_177958_n() - var5.field_70165_t;
            double var8 = (double)p_180441_2_.func_177956_o() - var5.field_70163_u;
            double var10 = (double)p_180441_2_.func_177952_p() - var5.field_70161_v;
            if(var6 * var6 + var8 * var8 + var10 * var10 < 1024.0D) {
               var5.field_71135_a.func_147359_a(new S25PacketBlockBreakAnim(p_180441_1_, p_180441_2_, p_180441_3_));
            }
         }
      }
