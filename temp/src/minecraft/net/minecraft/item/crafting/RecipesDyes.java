...
public class RecipesDyes {
   ...
   public void func_77607_a(CraftingManager p_77607_1_) {
      ...
      for(var2 = 0; var2 < 16; ++var2) {
         p_77607_1_.func_77596_b(new ItemStack(Blocks.field_150325_L, 1, var2), new Object[]{new ItemStack(Items.field_151100_aR, 1, 15 - var2), new ItemStack(Item.func_150898_a(Blocks.field_150325_L), 1, 0)});
         p_77607_1_.func_92103_a(new ItemStack(Blocks.field_150406_ce, 8, 15 - var2), new Object[]{"###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150405_ch), Character.valueOf('X'), new ItemStack(Items.field_151100_aR, 1, var2)});
         p_77607_1_.func_92103_a(new ItemStack(Blocks.field_150399_cn, 8, 15 - var2), new Object[]{"###", "#X#", "###", Character.valueOf('#'), new ItemStack(Blocks.field_150359_w), Character.valueOf('X'), new ItemStack(Items.field_151100_aR, 1, var2)});
