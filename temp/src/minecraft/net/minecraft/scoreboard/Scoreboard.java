...
public class Scoreboard {
   ...
   private final Map field_96545_a = Maps.newHashMap();
   private final Map field_96543_b = Maps.newHashMap();
   private final Map field_96544_c = Maps.newHashMap();
   private final ScoreObjective[] field_96541_d = new ScoreObjective[19];
   private final Map field_96542_e = Maps.newHashMap();
   private final Map field_96540_f = Maps.newHashMap();
