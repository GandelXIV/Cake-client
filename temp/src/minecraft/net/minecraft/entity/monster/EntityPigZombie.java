...
public class EntityPigZombie extends EntityZombie {
   ...
   protected void func_175456_n() {
      this.field_70715_bh.func_75776_a(1, new EntityPigZombie.AIHurtByAggressor());
      this.field_70715_bh.func_75776_a(2, new EntityPigZombie.AITargetAggressor());
   }
   ...
   public void func_70037_a(NBTTagCompound p_70037_1_) {
      ...
      String var2 = p_70037_1_.func_74779_i("HurtBy");
      if(var2.length() > 0) {
