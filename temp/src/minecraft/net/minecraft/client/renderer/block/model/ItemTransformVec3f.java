...
public class ItemTransformVec3f {
   ...
   static class Deserializer implements JsonDeserializer {
      ...
      public ItemTransformVec3f func_178359_a(JsonElement p_178359_1_, Type p_178359_2_, JsonDeserializationContext p_178359_3_) {
         ...
         var6.scale(0.0625F);
         MathHelper.func_151237_a((double)var6.x, -1.5D, 1.5D);
         MathHelper.func_151237_a((double)var6.y, -1.5D, 1.5D);
         MathHelper.func_151237_a((double)var6.z, -1.5D, 1.5D);
         Vector3f var7 = this.func_178358_a(var4, "scale", field_178361_c);
         MathHelper.func_151237_a((double)var7.x, -1.5D, 1.5D);
         MathHelper.func_151237_a((double)var7.y, -1.5D, 1.5D);
         MathHelper.func_151237_a((double)var7.z, -1.5D, 1.5D);
      ...
      private Vector3f func_178358_a(JsonObject p_178358_1_, String p_178358_2_, Vector3f p_178358_3_) {
         if(!p_178358_1_.has(p_178358_2_)) {
            ...
            JsonArray var4 = JsonUtils.func_151214_t(p_178358_1_, p_178358_2_);
            if(var4.size() != 3) {
               ...
               for(int var6 = 0; var6 < var5.length; ++var6) {
                  var5[var6] = JsonUtils.func_151220_d(var4.get(var6), p_178358_2_ + "[" + var6 + "]");
               }
