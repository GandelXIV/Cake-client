...
public class GlStateManager {
   ...
   private static GlStateManager.AlphaState field_179160_a = new GlStateManager.AlphaState((GlStateManager.SwitchTexGen)null);
   ...
   private static GlStateManager.ColorMaterialState field_179156_d = new GlStateManager.ColorMaterialState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.BlendState field_179157_e = new GlStateManager.BlendState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.DepthState field_179154_f = new GlStateManager.DepthState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.FogState field_179155_g = new GlStateManager.FogState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.CullState field_179167_h = new GlStateManager.CullState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.PolygonOffsetState field_179168_i = new GlStateManager.PolygonOffsetState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.ColorLogicState field_179165_j = new GlStateManager.ColorLogicState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.TexGenState field_179166_k = new GlStateManager.TexGenState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.ClearState field_179163_l = new GlStateManager.ClearState((GlStateManager.SwitchTexGen)null);
   private static GlStateManager.StencilState field_179164_m = new GlStateManager.StencilState((GlStateManager.SwitchTexGen)null);
   ...
   private static GlStateManager.ColorMask field_179171_s = new GlStateManager.ColorMask((GlStateManager.SwitchTexGen)null);
   ...
   public static void func_179149_a(GlStateManager.TexGen p_179149_0_, int p_179149_1_) {
      GlStateManager.TexGenCoord var2 = func_179125_c(p_179149_0_);
