...
public class GuiPageButtonList extends GuiListExtended {
   ...
   public boolean func_148179_a(int p_148179_1_, int p_148179_2_, int p_148179_3_) {
      ...
      int var5 = this.func_148124_c(p_148179_1_, p_148179_2_);
      if(var5 >= 0) {
   ...
   private GuiSlider func_178067_a(int p_178067_1_, int p_178067_2_, GuiPageButtonList.GuiSlideEntry p_178067_3_) {
      ...
      var4.field_146125_m = p_178067_3_.func_178934_d();
      return var4;
   }
   ...
   private GuiListButton func_178065_a(int p_178065_1_, int p_178065_2_, GuiPageButtonList.GuiButtonEntry p_178065_3_) {
      ...
      var4.field_146125_m = p_178065_3_.func_178934_d();
      return var4;
   }

   private GuiTextField func_178068_a(int p_178068_1_, int p_178068_2_, GuiPageButtonList.EditBoxEntry p_178068_3_) {
      GuiTextField var4 = new GuiTextField(p_178068_3_.func_178935_b(), this.field_148161_k.field_71466_p, p_178068_1_, p_178068_2_, 150, 20);
      var4.func_146180_a(p_178068_3_.func_178936_c());
      var4.func_175207_a(this.field_178076_z);
      var4.func_146189_e(p_178068_3_.func_178934_d());
   ...
   private GuiLabel func_178063_a(int p_178063_1_, int p_178063_2_, GuiPageButtonList.GuiLabelEntry p_178063_3_, boolean p_178063_4_) {
      GuiLabel var5;
      if(p_178063_4_) {
         var5 = new GuiLabel(this.field_148161_k.field_71466_p, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, this.field_148155_a - p_178063_1_ * 2, 20, -1);
      } else {
         var5 = new GuiLabel(this.field_148161_k.field_71466_p, p_178063_3_.func_178935_b(), p_178063_1_, p_178063_2_, 150, 20, -1);
      }

      var5.field_146172_j = p_178063_3_.func_178934_d();
      ...
      if(this.field_178075_A instanceof GuiTextField) {
         ...
         if(!GuiScreen.func_175279_e(p_178062_2_)) {
            if(p_178062_2_ == 15) {
               ...
               var3.func_146201_a(p_178062_1_, p_178062_2_);
            }
   ...
   public static class GuiEntry implements GuiListExtended.IGuiListEntry {
      ...
      private boolean func_178023_a(GuiButton p_178023_1_, int p_178023_2_, int p_178023_3_, int p_178023_4_) {
         boolean var5 = p_178023_1_.func_146116_c(this.field_178031_a, p_178023_2_, p_178023_3_);
         if(var5) {
