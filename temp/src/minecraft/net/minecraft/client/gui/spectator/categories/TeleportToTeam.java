...
public class TeleportToTeam implements ISpectatorMenuView, ISpectatorMenuObject {
   ...
   class TeamSelectionObject implements ISpectatorMenuObject {
      ...
      public TeamSelectionObject(ScorePlayerTeam p_i45492_2_) {
         ...
         Iterator var3 = p_i45492_2_.func_96670_d().iterator();
      ...
      public void func_178663_a(float p_178663_1_, int p_178663_2_) {
         ...
         if(var3 >= 0) {
            ...
            Gui.func_73734_a(1, 1, 15, 15, MathHelper.func_180183_b(var5 * p_178663_1_, var6 * p_178663_1_, var7 * p_178663_1_) | p_178663_2_ << 24);
         }
