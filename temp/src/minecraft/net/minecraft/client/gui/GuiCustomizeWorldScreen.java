...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
   ...
   public void func_73866_w_() {
      ...
      this.field_146292_n.add(this.field_175345_v = new GuiButton(302, 20, 5, 80, 20, I18n.func_135052_a("createWorld.customize.custom.prev", new Object[0])));
      this.field_146292_n.add(this.field_175344_w = new GuiButton(303, this.field_146294_l - 100, 5, 80, 20, I18n.func_135052_a("createWorld.customize.custom.next", new Object[0])));
      this.field_146292_n.add(this.field_175346_u = new GuiButton(304, this.field_146294_l / 2 - 187, this.field_146295_m - 27, 90, 20, I18n.func_135052_a("createWorld.customize.custom.defaults", new Object[0])));
      this.field_146292_n.add(this.field_175347_t = new GuiButton(301, this.field_146294_l / 2 - 92, this.field_146295_m - 27, 90, 20, I18n.func_135052_a("createWorld.customize.custom.randomize", new Object[0])));
      this.field_146292_n.add(this.field_175350_z = new GuiButton(305, this.field_146294_l / 2 + 3, this.field_146295_m - 27, 90, 20, I18n.func_135052_a("createWorld.customize.custom.presets", new Object[0])));
      this.field_146292_n.add(this.field_175348_s = new GuiButton(300, this.field_146294_l / 2 + 98, this.field_146295_m - 27, 90, 20, I18n.func_135052_a("gui.done", new Object[0])));
   ...
   private void func_175325_f() {
      ...
      for(int var5 = 0; var5 < 4; ++var5) {
         this.field_175342_h[var5] = I18n.func_135052_a("createWorld.customize.custom.page" + var5, new Object[0]);
      }
   ...
   public void func_175319_a(int p_175319_1_, String p_175319_2_) {
      ...
      if(var4 != var3 && var3 != 0.0F) {
         ((GuiTextField)this.field_175349_r.func_178061_c(p_175319_1_)).func_146180_a(this.func_175330_b(p_175319_1_, var4));
      }
      ...
      case 162:
         if(p_175330_2_ < 0.0F) {
            ...
            if((int)p_175330_2_ >= BiomeGenBase.field_76778_j.field_76756_M) {
               var3 = BiomeGenBase.func_150565_n()[(int)p_175330_2_ + 2];
               return var3 != null?var3.field_76791_y:"?";
            } else {
               var3 = BiomeGenBase.func_150565_n()[(int)p_175330_2_];
               return var3 != null?var3.field_76791_y:"?";
            }
         }
      }
   ...
   public void func_175320_a(int p_175320_1_, float p_175320_2_) {
      ...
      if(p_175320_1_ >= 100 && p_175320_1_ < 116) {
         ...
         if(var3 != null) {
            ((GuiTextField)var3).func_146180_a(this.func_175330_b(p_175320_1_, p_175320_2_));
         }
      }
   ...
   private void func_175329_a(boolean p_175329_1_) {
      ...
      this.field_175346_u.field_146124_l = !p_175329_1_;
   ...
   public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_) {
      ...
      if(this.field_175339_B != 0) {
         ...
         var7.func_178985_a((double)(this.field_146294_l / 2 - 90), 185.0D, 0.0D, 0.0D, 2.65625D);
         var7.func_178985_a((double)(this.field_146294_l / 2 + 90), 185.0D, 0.0D, 5.625D, 2.65625D);
         var7.func_178985_a((double)(this.field_146294_l / 2 + 90), 100.0D, 0.0D, 5.625D, 0.0D);
         var7.func_178985_a((double)(this.field_146294_l / 2 - 90), 100.0D, 0.0D, 0.0D, 0.0D);
         var6.func_78381_a();
