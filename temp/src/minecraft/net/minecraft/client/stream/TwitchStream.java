...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream {
   ...
   public void func_152922_k() {
      if(this.field_152951_c.func_152850_m() && !this.field_152951_c.func_152839_p()) {
         ...
         if(var7) {
            ...
            var15.func_178970_b();
            var15.func_178985_a(0.0D, (double)var11, 0.0D, 0.0D, (double)var13);
            var15.func_178985_a((double)var10, (double)var11, 0.0D, (double)var12, (double)var13);
            var15.func_178985_a((double)var10, 0.0D, 0.0D, (double)var12, 0.0D);
            var15.func_178985_a(0.0D, 0.0D, 0.0D, 0.0D, 0.0D);
            var14.func_78381_a();
            var9.func_147606_d();
   ...
   public void func_176026_a(Metadata p_176026_1_, long p_176026_2_, long p_176026_4_) {
      if(this.func_152934_n() && this.field_152957_i) {
         ...
         long var10 = this.field_152951_c.func_177946_b(p_176026_1_.func_152810_c(), var6 + p_176026_2_, var8, var9);
         if(var10 < 0L) {
         ...
         } else if(this.field_152951_c.func_177947_a(p_176026_1_.func_152810_c(), var6 + p_176026_4_, var10, var8, var9)) {
