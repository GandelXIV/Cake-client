...
public class CommandSetDefaultSpawnpoint extends CommandBase {
   ...
   public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_) throws CommandException {
      ...
      if(p_71515_2_.length == 0) {
         var3 = func_71521_c(p_71515_1_).func_180425_c();
      } else {
         if(p_71515_2_.length != 3 || p_71515_1_.func_130014_f_() == null) {
            throw new WrongUsageException("commands.setworldspawn.usage", new Object[0]);
         }

         var3 = func_175757_a(p_71515_1_, p_71515_2_, 0, true);
      }

      p_71515_1_.func_130014_f_().func_175652_B(var3);
      MinecraftServer.func_71276_C().func_71203_ab().func_148540_a(new S05PacketSpawnPosition(var3));
      func_152373_a(p_71515_1_, this, "commands.setworldspawn.success", new Object[]{Integer.valueOf(var3.func_177958_n()), Integer.valueOf(var3.func_177956_o()), Integer.valueOf(var3.func_177952_p())});
   }
