...
public class ServerCommandManager extends CommandHandler implements IAdminCommand {
   ...
   public void func_152372_a(ICommandSender p_152372_1_, ICommand p_152372_2_, int p_152372_3_, String p_152372_4_, Object ... p_152372_5_) {
      ...
      ChatComponentTranslation var8 = new ChatComponentTranslation("chat.type.admin", new Object[]{p_152372_1_.func_70005_c_(), new ChatComponentTranslation(p_152372_4_, p_152372_5_)});
      var8.func_150256_b().func_150238_a(EnumChatFormatting.GRAY);
      var8.func_150256_b().func_150217_b(Boolean.valueOf(true));
      if(var6) {
         Iterator var9 = var7.func_71203_ab().field_72404_b.iterator();

         while(var9.hasNext()) {
            EntityPlayer var10 = (EntityPlayer)var9.next();
            if(var10 != p_152372_1_ && var7.func_71203_ab().func_152596_g(var10.func_146103_bH()) && p_152372_2_.func_71519_b(p_152372_1_)) {
               var10.func_145747_a(var8);
            }
         }
      }

      if(p_152372_1_ != var7 && var7.field_71305_c[0].func_82736_K().func_82766_b("logAdminCommands")) {
         var7.func_145747_a(var8);
      }

      boolean var11 = var7.field_71305_c[0].func_82736_K().func_82766_b("sendCommandFeedback");
      if(p_152372_1_ instanceof CommandBlockLogic) {
         var11 = ((CommandBlockLogic)p_152372_1_).func_175571_m();
      }
