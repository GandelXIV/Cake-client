...
public class NibbleArray {
   ...
   public int func_177480_a(int p_177480_1_) {
      int var2 = this.func_177478_c(p_177480_1_);
      return this.func_177479_b(p_177480_1_)?this.field_76585_a[var2] & 15:this.field_76585_a[var2] >> 4 & 15;
   }

   public void func_177482_a(int p_177482_1_, int p_177482_2_) {
      int var3 = this.func_177478_c(p_177482_1_);
      if(this.func_177479_b(p_177482_1_)) {
         this.field_76585_a[var3] = (byte)(this.field_76585_a[var3] & 240 | p_177482_2_ & 15);
      } else {
         this.field_76585_a[var3] = (byte)(this.field_76585_a[var3] & 15 | (p_177482_2_ & 15) << 4);
      }
