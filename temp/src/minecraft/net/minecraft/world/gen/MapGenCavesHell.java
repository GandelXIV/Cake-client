...
public class MapGenCavesHell extends MapGenBase {
   ...
   protected void func_180704_a(long p_180704_1_, int p_180704_3_, int p_180704_4_, ChunkPrimer p_180704_5_, double p_180704_6_, double p_180704_8_, double p_180704_10_, float p_180704_12_, float p_180704_13_, float p_180704_14_, int p_180704_15_, int p_180704_16_, double p_180704_17_) {
      ...
      for(boolean var28 = var25.nextInt(6) == 0; p_180704_15_ < p_180704_16_; ++p_180704_15_) {
         double var29 = 1.5D + (double)(MathHelper.func_76126_a((float)p_180704_15_ * 3.1415927F / (float)p_180704_16_) * p_180704_12_ * 1.0F);
         double var31 = var29 * p_180704_17_;
         float var33 = MathHelper.func_76134_b(p_180704_14_);
         float var34 = MathHelper.func_76126_a(p_180704_14_);
         p_180704_6_ += (double)(MathHelper.func_76134_b(p_180704_13_) * var33);
         p_180704_8_ += (double)var34;
         p_180704_10_ += (double)(MathHelper.func_76126_a(p_180704_13_) * var33);
         if(var28) {
            p_180704_14_ *= 0.92F;
         } else {
            p_180704_14_ *= 0.7F;
         ...
         if(var52 || var25.nextInt(4) != 0) {
            ...
            if(p_180704_6_ >= var19 - 16.0D - var29 * 2.0D && p_180704_10_ >= var21 - 16.0D - var29 * 2.0D && p_180704_6_ <= var19 + 16.0D + var29 * 2.0D && p_180704_10_ <= var21 + 16.0D + var29 * 2.0D) {
               int var53 = MathHelper.func_76128_c(p_180704_6_ - var29) - p_180704_3_ * 16 - 1;
               int var36 = MathHelper.func_76128_c(p_180704_6_ + var29) - p_180704_3_ * 16 + 1;
               int var54 = MathHelper.func_76128_c(p_180704_8_ - var31) - 1;
               int var38 = MathHelper.func_76128_c(p_180704_8_ + var31) + 1;
               int var55 = MathHelper.func_76128_c(p_180704_10_ - var29) - p_180704_4_ * 16 - 1;
               int var40 = MathHelper.func_76128_c(p_180704_10_ + var29) - p_180704_4_ * 16 + 1;
               if(var53 < 0) {
                  var53 = 0;
               }
                  ...
                  for(int var43 = var55; !var56 && var43 < var40; ++var43) {
                     for(int var44 = var38 + 1; !var56 && var44 >= var54 - 1; --var44) {
                        if(var44 >= 0 && var44 < 128) {
                           IBlockState var45 = p_180704_5_.func_177856_a(var42, var44, var43);
                     ...
                     for(int var58 = var55; var58 < var40; ++var58) {
                        ...
                        for(int var48 = var38; var48 > var54; --var48) {
                           ...
                           if(var49 > -0.7D && var57 * var57 + var49 * var49 + var46 * var46 < 1.0D) {
                              IBlockState var51 = p_180704_5_.func_177856_a(var42, var48, var58);
                              if(var51.func_177230_c() == Blocks.field_150424_aL || var51.func_177230_c() == Blocks.field_150346_d || var51.func_177230_c() == Blocks.field_150349_c) {
                                 p_180704_5_.func_177855_a(var42, var48, var58, Blocks.field_150350_a.func_176223_P());
                              }
                           }
                        }
                     }
   ...
   protected void func_180701_a(World p_180701_1_, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) {
      ...
      for(int var8 = 0; var8 < var7; ++var8) {
         ...
         if(this.field_75038_b.nextInt(4) == 0) {
            this.func_180705_a(this.field_75038_b.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var9, var11, var13);
         ...
         for(int var16 = 0; var16 < var15; ++var16) {
            ...
            this.func_180704_a(this.field_75038_b.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var9, var11, var13, var19 * 2.0F, var17, var18, 0, 0, 0.5D);
         }
      }
