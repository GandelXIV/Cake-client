...
public class MapGenRavine extends MapGenBase {
   ...
   protected void func_180707_a(long p_180707_1_, int p_180707_3_, int p_180707_4_, ChunkPrimer p_180707_5_, double p_180707_6_, double p_180707_8_, double p_180707_10_, float p_180707_12_, float p_180707_13_, float p_180707_14_, int p_180707_15_, int p_180707_16_, double p_180707_17_) {
      ...
      for(; p_180707_15_ < p_180707_16_; ++p_180707_15_) {
         double var53 = 1.5D + (double)(MathHelper.func_76126_a((float)p_180707_15_ * 3.1415927F / (float)p_180707_16_) * p_180707_12_ * 1.0F);
         double var30 = var53 * p_180707_17_;
         var53 *= (double)var19.nextFloat() * 0.25D + 0.75D;
         var30 *= (double)var19.nextFloat() * 0.25D + 0.75D;
         float var32 = MathHelper.func_76134_b(p_180707_14_);
         float var33 = MathHelper.func_76126_a(p_180707_14_);
         p_180707_6_ += (double)(MathHelper.func_76134_b(p_180707_13_) * var32);
         p_180707_8_ += (double)var33;
         p_180707_10_ += (double)(MathHelper.func_76126_a(p_180707_13_) * var32);
         p_180707_14_ *= 0.7F;
         ...
         if(var52 || var19.nextInt(4) != 0) {
            ...
            if(p_180707_6_ >= var20 - 16.0D - var53 * 2.0D && p_180707_10_ >= var22 - 16.0D - var53 * 2.0D && p_180707_6_ <= var20 + 16.0D + var53 * 2.0D && p_180707_10_ <= var22 + 16.0D + var53 * 2.0D) {
               int var54 = MathHelper.func_76128_c(p_180707_6_ - var53) - p_180707_3_ * 16 - 1;
               int var35 = MathHelper.func_76128_c(p_180707_6_ + var53) - p_180707_3_ * 16 + 1;
               int var55 = MathHelper.func_76128_c(p_180707_8_ - var30) - 1;
               int var37 = MathHelper.func_76128_c(p_180707_8_ + var30) + 1;
               int var56 = MathHelper.func_76128_c(p_180707_10_ - var53) - p_180707_4_ * 16 - 1;
               int var39 = MathHelper.func_76128_c(p_180707_10_ + var53) - p_180707_4_ * 16 + 1;
               if(var54 < 0) {
                  var54 = 0;
               }
                  ...
                  for(int var42 = var56; !var57 && var42 < var39; ++var42) {
                     for(int var43 = var37 + 1; !var57 && var43 >= var55 - 1; --var43) {
                        if(var43 >= 0 && var43 < 256) {
                           IBlockState var44 = p_180707_5_.func_177856_a(var41, var43, var42);
                        ...
                        if(var58 * var58 + var45 * var45 < 1.0D) {
                           for(int var48 = var37; var48 > var55; --var48) {
                              ...
                              if((var58 * var58 + var45 * var45) * (double)this.field_75046_d[var48 - 1] + var49 * var49 / 6.0D < 1.0D) {
                                 IBlockState var51 = p_180707_5_.func_177856_a(var41, var48, var59);
                                 if(var51.func_177230_c() == Blocks.field_150349_c) {
                                    var47 = true;
                                 }

                                 if(var51.func_177230_c() == Blocks.field_150348_b || var51.func_177230_c() == Blocks.field_150346_d || var51.func_177230_c() == Blocks.field_150349_c) {
                                    if(var48 - 1 < 10) {
                                       p_180707_5_.func_177855_a(var41, var48, var59, Blocks.field_150356_k.func_176223_P());
                                    } else {
                                       p_180707_5_.func_177855_a(var41, var48, var59, Blocks.field_150350_a.func_176223_P());
                                       if(var47 && p_180707_5_.func_177856_a(var41, var48 - 1, var59).func_177230_c() == Blocks.field_150346_d) {
                                          p_180707_5_.func_177855_a(var41, var48 - 1, var59, this.field_75039_c.func_180494_b(new BlockPos(var41 + p_180707_3_ * 16, 0, var59 + p_180707_4_ * 16)).field_76752_A);
                                       }
                                    }
                                 }
                              }
   ...
   protected void func_180701_a(World p_180701_1_, int p_180701_2_, int p_180701_3_, int p_180701_4_, int p_180701_5_, ChunkPrimer p_180701_6_) {
      if(this.field_75038_b.nextInt(50) == 0) {
         double var7 = (double)(p_180701_2_ * 16 + this.field_75038_b.nextInt(16));
         double var9 = (double)(this.field_75038_b.nextInt(this.field_75038_b.nextInt(40) + 8) + 20);
         double var11 = (double)(p_180701_3_ * 16 + this.field_75038_b.nextInt(16));
         byte var13 = 1;
         ...
         for(int var14 = 0; var14 < var13; ++var14) {
            ...
            this.func_180707_a(this.field_75038_b.nextLong(), p_180701_4_, p_180701_5_, p_180701_6_, var7, var9, var11, var17, var15, var16, 0, 0, 3.0D);
         }
